 ...
 */
export type SocialNotificationType = "FOLLOW" | "LIKE" | "COMMENT" | "MENTION";
 ...
 */
export type SystemNotificationType = "MESSAGE" | "FRIEND_REQUEST";
...
export interface NotificationDataPayload {
  ...
  readonly resourceType?: "post" | "team" | "user" | "stat" | "message";
  /** Additional metadata */
...
export const NOTIFICATION_CATEGORIES = {
  SOCIAL: ["FOLLOW", "LIKE", "COMMENT", "MENTION"] as const,
  TEAM: [
    "TEAM_INVITE",
    "TEAM_EXPIRING",
    "MEMBER_JOINED",
  ...
  SYSTEM: ["MESSAGE", "FRIEND_REQUEST"] as const,
} as const;
...
/**
 * Type guard to check if notification type is team-related
 */
export const isTeamNotification = (
  type: NotificationType
): type is TeamNotificationType => {
  return NOTIFICATION_CATEGORIES.TEAM.includes(type as TeamNotificationType);
};
 ...
 */
export interface TeamInviteNotificationData extends NotificationDataPayload {
...
export interface SocialNotificationData extends NotificationDataPayload {
  ...
  readonly resourceId: string;
  readonly interactionType?: "like" | "comment" | "follow";
}
...
export type TypedDatabaseNotification<T extends NotificationType> =
  T extends "TEAM_INVITE"
    ? DatabaseNotification<TeamInviteNotificationData>
